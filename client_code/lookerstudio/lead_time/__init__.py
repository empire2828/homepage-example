from ._anvil_designer import lead_timeTemplate
from anvil import *
...
class lead_time(lead_timeTemplate):
  ...
  def init_iframe(self, supabase_key):
    base_url = "https://lookerstudio.google.com/embed/reporting/d1557a62-b6f7-470e-93b1-42e5c54ef3de/page/p_8hyzd253td"
