from ._anvil_designer import occupancyTemplate
from anvil import *
...
class occupancy(occupancyTemplate):
  ...
  def init_iframe(self, supabase_key):
    base_url = "https://lookerstudio.google.com/embed/reporting/d1557a62-b6f7-470e-93b1-42e5c54ef3de/page/p_1idplf63td"
